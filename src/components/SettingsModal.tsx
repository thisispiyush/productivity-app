...
import { Download, Moon, Pencil, Sun, Trash2, Upload } from 'lucide-react'
              ...
              <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
                ...
                <div className="flex items-center gap-6 mb-8">
                  <button
                    ...
                    className="group relative grid h-16 w-16 place-items-center overflow-hidden rounded-full border border-border bg-surface text-sm font-semibold text-foreground transition-colors hover:bg-[var(--surface-hover)]"
                  ...
                  />
                  <div>
                    <div className="text-sm text-muted-foreground mb-1">Avatar</div>
                    <div className="text-xs text-muted-foreground">Click the image to change your profile photo.</div>
                  </div>
                </div>
