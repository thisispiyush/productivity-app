  ...
  ({ className, ...props }, ref) => (
    <div
      ...
      className={cn(
        ...
        'rounded-[14px] border border-[color:var(--border-strong)] bg-card text-foreground hover-glow transition-all duration-200 will-change-transform hover:-translate-y-0.5 hover:border-[color:var(--border-hover)]',
        className,
      )}
      {...props}
    />
